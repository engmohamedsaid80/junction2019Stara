#pragma checksum "D:\MyWork\junction\junction2019Stara\source\Web\D-STARA\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ca6332f256ec21111987f42b01f670f7cc7b68bf"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ca6332f256ec21111987f42b01f670f7cc7b68bf", @"/Views/Home/Index.cshtml")]
...
#nullable disable
            WriteLiteral("\"]);\r\n");
#nullable restore
#line 179 "D:\MyWork\junction\junction2019Stara\source\Web\D-STARA\Views\Home\Index.cshtml"
       ...
       // alert(""2"");
        for (i = 0; i < longitudes.length; i++) {
           ...
           // else {
            ...
            //}
            //sortedLocations.");
            WriteLiteral(@"push([distance, latitudes[i], longitudes[i], locAddress[i], locDesc[i], locRegion[i], locName[i], locPhone[i]]);
        }
        ...
        for (i = 0; i < sortedLocations.length; i++) {
          ...
          ");
            ...
            var link = '<div class=""branchWrapper""><a href=""javascript:markerClick(' + i + ');"" Id=' + i + '><h3>Project No:' + sortedLocations[i][6] +
                ...
                '<dl><dt>' + 'Start Date: </dt><dd>' + sortedLocations[i][7] + '</dd> </dl><br/> <br/>' +
                '<dl><dt>' + 'End Date: </dt><dd>' + sortedLocations[i][7] + '</dd> </dl><br/> <br/>' +
